...
<head>
  ...
  <title>Admin Dashboard - Authors</title>
</head>

<body>
  <nav class="navbar text-dark navbar-expand-lg bg-dark mr-3">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Books R Us / Admin Dashboard/ Authors</a>
      </div>
    </div>
  </nav>
  <table class="table mt-5">
    ...
    <?php 
      foreach ($paginated_data as $book_data) {
        echo '<tr>';
        echo '<th scope="col" id="category-name">' . $book_data['author'] . '</th>';
