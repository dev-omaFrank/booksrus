...
<head>
  ...
  <title>Admin Dashboard - Location</title>
</head>

<body>
  <nav class="navbar text-dark navbar-expand-lg bg-dark mr-3">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Books R Us / Admin Dashboard/ Location Rack</a>
      </div>
    </div>
  </nav>
  <table class="table mt-5">
    <thead class="bg-dark text-white">
      <tr>
        <th scope="col">Location Rack Name</th>
    ...
    <?php 
      foreach ($paginated_data as $book_data) {
        echo '<tr>';
        echo '<th scope="col" id="category-name">' . $book_data['location'] . '</th>';
